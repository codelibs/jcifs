...
public class FileBothDirectoryInfo implements FileEntry, Decodable {
    ...
    public String toString() {
        return ("SmbFindFileBothDirectoryInfo[" + "nextEntryOffset=" + this.nextEntryOffset + ",fileIndex=" + this.fileIndex
                + ",creationTime=" + new Date(this.creationTime) + ",lastAccessTime=" + new Date(this.lastAccessTime) + ",lastWriteTime="
