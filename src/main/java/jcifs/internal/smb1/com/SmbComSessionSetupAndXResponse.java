...
public class SmbComSessionSetupAndXResponse extends AndXServerMessageBlock {
    ...
    public String toString() {
        return ("SmbComSessionSetupAndXResponse[" + super.toString() + ",isLoggedInAsGuest=" + this.isLoggedInAsGuest + ",nativeOs="
                + this.nativeOs + ",nativeLanMan=" + this.nativeLanMan + ",primaryDomain=" + this.primaryDomain + "]");
    }
}
