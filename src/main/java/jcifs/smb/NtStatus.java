...
public interface NtStatus {
    ...
    public static final int NT_STATUS_INSUFFICIENT_RESOURCES = 0xC000009a;
    ...
    static final int[] NT_STATUS_CODES = {
        NT_STATUS_SUCCESS, NT_STATUS_PENDING, NT_STATUS_NOTIFY_ENUM_DIR, NT_STATUS_BUFFER_OVERFLOW, NT_STATUS_UNSUCCESSFUL, NT_STATUS_NOT_IMPLEMENTED,
