...
public class NtlmHttpURLConnection extends HttpURLConnection {
    ...
    public void setRequestProperty(final String key, final String value) {
        ...
        for (final Entry<String, List<String>> entry : this.requestProperties.entrySet()) {
    ...
    public void addRequestProperty(final String key, final String value) {
        ...
        final Iterator<String> propertyValues = values.iterator();
    ...
    private NtlmMessage attemptNegotiation(final int response) throws IOException, GeneralSecurityException {
        ...
        try (InputStream errorStream = this.connection.getErrorStream()) {
            ...
            if (message == null) {
                ...
                message = new Type3Message(this.transportContext, type2, null, password, domain, user,
                        this.transportContext.getNameServiceClient().getLocalHost().getHostName(), 0);
            }
            return message;
        }
    }
    ...
    private void reconnect() throws IOException {
        final int readTimeout = getReadTimeout();
        ...
        this.headerFields = null;
        for (final Entry<String, List<String>> property : this.requestProperties.entrySet()) {
            final String key = property.getKey();
            final StringBuilder value = new StringBuilder();
            final Iterator<String> values = property.getValue().iterator();
            while (values.hasNext()) {
