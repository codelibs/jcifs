 ...
 * credentials are retrieved from the <tt>jcifs.smb1.smb.client.domain</tt>,
 * <tt>jcifs.smb1.smb.client.username</tt>, and <tt>jcifs.smb1.smb.client.password</tt>
 * properties.
 * <p>
 ...
 * will be substituted with <tt>jcifs.smb1.smb.client.domain</tt>,
 * <tt>jcifs.smb1.smb.client.username</tt>, <tt>jcifs.smb1.smb.client.password</tt>
 * property values.
 */
    ...
    public byte[] getSigningKey(byte[] challenge) throws SmbException
    {
        switch (LM_COMPATIBILITY) {
            ...
            case 5:
                 ...
                 */
                throw new SmbException("NTLMv2 requires extended security (jcifs.smb1.smb.client.useExtendedSecurity must be true if jcifs.smb1.smb.lmCompatibility >= 3)");
        }
        return null;
    }
