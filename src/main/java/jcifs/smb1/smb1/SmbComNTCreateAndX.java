...
class SmbComNTCreateAndX extends AndXServerMessageBlock {
    ...
    public String toString() {
        return ("SmbComNTCreateAndX[" + super.toString() + ",flags=0x" + Hexdump.toHexString(flags0, 2) + ",rootDirectoryFid="
                ...
                + ",createOptions=0x" + Hexdump.toHexString(createOptions, 8) + ",impersonationLevel=0x"
                + Hexdump.toHexString(impersonationLevel, 4) + ",securityFlags=0x" + Hexdump.toHexString(securityFlags, 2) + ",name=" + path
                + "]");
    }
}
