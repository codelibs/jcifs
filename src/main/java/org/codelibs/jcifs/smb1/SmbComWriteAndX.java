...
class SmbComWriteAndX extends AndXServerMessageBlock {
    ...
    private static final int READ_ANDX_BATCH_LIMIT = Config.getInt("jcifs.client.WriteAndX.ReadAndX", 1);
    private static final int CLOSE_BATCH_LIMIT = Config.getInt("jcifs.client.WriteAndX.Close", 1);
