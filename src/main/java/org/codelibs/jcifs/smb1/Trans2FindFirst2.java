...
class Trans2FindFirst2 extends SmbComTransaction {
    ...
    static final int LIST_SIZE = Config.getInt("jcifs.client.listSize", DEFAULT_LIST_SIZE);
    static final int LIST_COUNT = Config.getInt("jcifs.client.listCount", DEFAULT_LIST_COUNT);
