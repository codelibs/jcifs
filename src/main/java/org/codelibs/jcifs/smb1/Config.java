...
public class Config {
     ...
     *     at org.codelibs.jcifs.smb1.smb1.SmbFile.&lt;init&gt;(SmbFile.java:355)
     *     ...
     * </pre></blockquote>
     */
    ...
    public static void registerSmbURLHandler() {
        ...
        if (ver.startsWith("1.1.") || ver.startsWith("1.2.")) {
            throw new RuntimeException("org.codelibs.jcifs requires Java 17 or above. You are running " + ver);
        }
        pkgs = System.getProperty("java.protocol.handler.pkgs");
        if (pkgs == null) {
            System.setProperty("java.protocol.handler.pkgs", "org.codelibs.jcifs");
        } else if (pkgs.indexOf("org.codelibs.jcifs") == -1) {
            pkgs += "|org.codelibs.jcifs";
    ...
    public static void setProperties(final Properties prp) {
        ...
        try {
            ...
            if (LogStream.level > 1) {
                log.println("SecurityException: org.codelibs.jcifs.smb1 will ignore System properties");
            }
        }
    }
    ...
    public static InetAddress getLocalHost() {
        final String addr = prp.getProperty("jcifs.client.laddr");
        ...
        if (addr != null) {
            try {
                ...
                if (LogStream.level > 0) {
                    log.println("Ignoring jcifs.client.laddr address: " + addr);
                    uhe.printStackTrace(log);
                }
            }
        }
