...
import org.codelibs.jcifs.smb1.util.RC4;
...
public class Type3Message extends NtlmMessage {
    ...
    static {
        ...
        DEFAULT_USER = Config.getProperty("jcifs.client.username", null);
        DEFAULT_PASSWORD = Config.getProperty("jcifs.client.password", null);
        String defaultWorkstation = null;
        try {
            defaultWorkstation = NbtAddress.getLocalHost().getHostName();
        } catch (final UnknownHostException ex) {}
        DEFAULT_WORKSTATION = defaultWorkstation;
        LM_COMPATIBILITY = Config.getInt("jcifs.lmCompatibility", 3);
    }
