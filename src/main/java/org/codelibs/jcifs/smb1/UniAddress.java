...
import org.codelibs.jcifs.smb1.netbios.Lmhosts;
 ...
 * handled internally to the <code>org.codelibs.jcifs.smb1.smb1</code> package.
 * <p>
 * This class is a wrapper for both {@link org.codelibs.jcifs.smb1.netbios.NbtAddress}
 ...
 * and the <code>org.codelibs.jcifs.smb1.resolveOrder</code> property. Changing
...
public class UniAddress {
    ...
    static {
        ...
        if (ro == null || ro.length() == 0) {
             ...
             * LMHOSTS,BCAST,DNS if org.codelibs.jcifs.smb1.netbios.wins has not
             * been specified.
             */
                ...
                if (s.equalsIgnoreCase("LMHOSTS")) {
                    ...
                    if (nbns == null) {
                        if (LogStream.level > 1) {
                            log.println(
                                    "UniAddress resolveOrder specifies WINS however the " + "jcifs.netbios.wins property has not been set");
                        }
                        continue;
                    }
                    tmp[i] = RESOLVER_WINS;
    ...
    */
     ...
     * method is used exclusively by the <code>org.codelibs.jcifs.smb1.smb1</code> package.
     *
