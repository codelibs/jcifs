...
abstract class SmbComTransaction extends ServerMessageBlock implements Enumeration {
    ...
    private static final int DEFAULT_MAX_DATA_COUNT =
            Config.getInt("jcifs.client.transaction_buf_size", SmbComTransaction.TRANSACTION_BUF_SIZE) - 512;
    ...
    public String toString() {
        return (super.toString() + ",totalParameterCount=" + totalParameterCount + ",totalDataCount=" + totalDataCount
                ...
                + ",dataOffset=" + dataOffset + ",dataDisplacement=" + dataDisplacement + ",setupCount=" + setupCount + ",pad=" + pad
                + ",pad1=" + pad1);
    }
}
