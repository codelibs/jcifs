...
class SmbComTreeConnectAndX extends AndXServerMessageBlock {
    ...
    private static final boolean DISABLE_PLAIN_TEXT_PASSWORDS = Config.getBoolean("jcifs.client.disablePlainTextPasswords", true);
    ...
    static {
        String s = Config.getProperty("jcifs.client.TreeConnectAndX.CheckDirectory");

        if (s != null) {
            batchLimits[0] = Byte.parseByte(s);
        }
        if ((s = Config.getProperty("jcifs.client.TreeConnectAndX.CreateDirectory")) != null) {
            batchLimits[2] = Byte.parseByte(s);
        }
        if ((s = Config.getProperty("jcifs.client.TreeConnectAndX.Delete")) != null) {
            batchLimits[3] = Byte.parseByte(s);
        }
        if ((s = Config.getProperty("jcifs.client.TreeConnectAndX.DeleteDirectory")) != null) {
            batchLimits[4] = Byte.parseByte(s);
        }
        if ((s = Config.getProperty("jcifs.client.TreeConnectAndX.OpenAndX")) != null) {
            batchLimits[5] = Byte.parseByte(s);
        }
        if ((s = Config.getProperty("jcifs.client.TreeConnectAndX.Rename")) != null) {
            batchLimits[6] = Byte.parseByte(s);
        }
        if ((s = Config.getProperty("jcifs.client.TreeConnectAndX.Transaction")) != null) {
            batchLimits[7] = Byte.parseByte(s);
        }
        if ((s = Config.getProperty("jcifs.client.TreeConnectAndX.QueryInformation")) != null) {
