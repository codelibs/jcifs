...
import org.codelibs.jcifs.smb1.dcerpc.msrpc.MsrpcDfsRootEnum;
import org.codelibs.jcifs.smb1.dcerpc.msrpc.MsrpcShareEnum;
import org.codelibs.jcifs.smb1.dcerpc.msrpc.MsrpcShareGetInfo;
 ...
 * {@code org.codelibs.jcifs.smb1.Config.registerSmbURLHandler();} method. This is required
 ...
 * are. It is also likely that properties must be specified for org.codelibs.jcifs.smb1
 ...
 * </td></tr>
 *
 * <tr><td ><code>smb1://angus.foo.net/d/org.codelibs.jcifs.smb/smb1/pipes.doc</code></td><td>
...
public class SmbFile extends URLConnection implements SmbConstants {
    ...
    static {
        ...
        try {
            Class.forName("org.codelibs.jcifs.smb1.Config");
        } catch (final ClassNotFoundException cnfe) {
            logger.error("Failed to load org.codelibs.jcifs.smb1.Config class", cnfe);
        }
        attrExpirationPeriod = Config.getLong("jcifs.client.attrExpirationPeriod", DEFAULT_ATTR_EXPIRATION_PERIOD);
        ignoreCopyToException = Config.getBoolean("jcifs.client.ignoreCopyToException", true);
        dfs = new Dfs();
    }
    ...
    Info queryPath(final String path, final int infoLevel) throws SmbException {
         ...
         * regardless of what org.codelibs.jcifs.smb1.smb1.client.useNTSmbs is set
    ...
    */
    ...
    /**
     * Returns the owner user SIDObject for this file
     *
     * @return the owner user SIDObject
     * @throws IOException if an I/O error occurs
     */
    ...
    /**
     * Returns the owner group SIDObject for this file
     *
     * @return the owner group SIDObject
     * @throws IOException if an I/O error occurs
     */
