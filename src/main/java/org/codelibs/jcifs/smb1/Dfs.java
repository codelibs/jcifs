...
public class Dfs {
    ...
    static final boolean strictView = Config.getBoolean("jcifs.client.dfs.strictView", false);
    static final long TTL = Config.getLong("jcifs.client.dfs.ttl", 300);
    static final boolean DISABLED = Config.getBoolean("jcifs.client.dfs.disabled", false);
