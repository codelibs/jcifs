...
class SmbComOpenAndX extends AndXServerMessageBlock {
    ...
    private static final int BATCH_LIMIT = Config.getInt("jcifs.client.OpenAndX.ReadAndX", 1);
    ...
    public String toString() {
        return ("SmbComOpenAndX[" + super.toString() + ",flags=0x" + Hexdump.toHexString(flags, 2) + ",desiredAccess=0x"
                ...
                + ",openFunction=0x" + Hexdump.toHexString(openFunction, 2) + ",allocationSize=" + allocationSize + ",fileName=" + path
                + "]");
    }
}
