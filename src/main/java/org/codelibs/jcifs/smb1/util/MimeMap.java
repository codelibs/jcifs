...
public class MimeMap {
    ...
    public MimeMap() throws IOException {
        ...
        in = new byte[IN_SIZE];
        final InputStream is = getClass().getClassLoader().getResourceAsStream("org/codelibs/jcifs/smb1/util/mime.map");
        ...
        if (inLen < 100 || inLen == IN_SIZE) {
            throw new IOException("Error reading org.codelibs.jcifs.smb/smb1/util/mime.map resource");
        }
        is.close();
    }
