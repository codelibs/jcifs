...
import org.codelibs.jcifs.smb.internal.smb1.com.SmbComLogoffAndX;
import org.codelibs.jcifs.smb.internal.smb1.com.SmbComNegotiateResponse;
import org.codelibs.jcifs.smb.internal.smb1.com.SmbComSessionSetupAndX;
import org.codelibs.jcifs.smb.internal.smb1.com.SmbComSessionSetupAndXResponse;
...
import org.codelibs.jcifs.smb.internal.smb2.multichannel.ChannelInfo;
import org.codelibs.jcifs.smb.internal.smb2.multichannel.ChannelManager;
...
import org.codelibs.jcifs.smb.internal.smb2.session.Smb2LogoffRequest;
import org.codelibs.jcifs.smb.internal.smb2.session.Smb2SessionSetupRequest;
import org.codelibs.jcifs.smb.internal.smb2.session.Smb2SessionSetupResponse;
import org.codelibs.jcifs.smb.internal.witness.WitnessClient;
import org.codelibs.jcifs.smb.internal.witness.WitnessNotification;
import org.codelibs.jcifs.smb.internal.witness.WitnessRegistration;
...
final class SmbSessionImpl implements SmbSessionInternal {
     ...
     * {@inheritDoc}
     *
     * @see org.codelibs.jcifs.smb.SmbSession#unwrap(java.lang.Class)
     */
    ...
    private static boolean isExternalAuth(CIFSContext tc, NtlmPasswordAuthenticator npa) {
        return npa instanceof org.codelibs.jcifs.smb.NtlmPasswordAuthentication && ((NtlmPasswordAuthentication) npa).areHashesExternal()
