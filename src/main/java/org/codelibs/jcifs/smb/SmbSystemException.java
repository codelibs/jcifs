 ...
 */
public class SmbSystemException extends CIFSException {
    ...
    public enum Severity {
        ...
        PERMANENT,
        /** Connection or session must be terminated */
        FATAL
    }
    ...
    /** The SMB error code associated with this exception */
    ...
    /** Optional hint for recovering from this error */
     ...
     */
    public SmbSystemException(String message, int errorCode, Severity severity, Category category) {
        super(message);
     ...
     */
    public SmbSystemException(String message, int errorCode, Severity severity, Category category, Throwable cause) {
        super(message, cause);
        this.errorCode = errorCode;
        this.severity = severity;
        this.category = category;
     ...
     * @param category the error category
     */
    public SmbSystemException(String message, int errorCode, Category category) {
     ...
     */
    public SmbSystemException withContext(String key, Object value) {
     ...
     * @return this exception for chaining
     */
    public SmbSystemException withRecoveryHint(String hint) {
