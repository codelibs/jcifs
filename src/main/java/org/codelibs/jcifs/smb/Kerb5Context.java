...
class Kerb5Context implements SSPContext {
     ...
     * {@inheritDoc}
     *
     * @see org.codelibs.jcifs.smb.SSPContext#isSupported(org.bouncycastle.asn1.ASN1ObjectIdentifier)
     */
    @Override
     ...
     * {@inheritDoc}
     *
     * @see org.codelibs.jcifs.smb.SSPContext#supportsIntegrity()
     */
    @Override
     ...
     *
     * @see org.codelibs.jcifs.smb.SSPContext#calculateMIC(byte[])
     */
    @Override
