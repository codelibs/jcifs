...
final class SmbSessionImpl implements SmbSessionInternal {
    ...
    private static boolean isExternalAuth(CIFSContext tc, NtlmPasswordAuthenticator npa) {
        return npa instanceof org.codelibs.jcifs.smb.impl.NtlmPasswordAuthentication
                && ((NtlmPasswordAuthentication) npa).areHashesExternal() && tc.getConfig().getDefaultPassword() != null;
    }
