...
class SmbPipeHandleImpl implements SmbPipeHandleInternal {
     ...
     * {@inheritDoc}
     *
     * @see org.codelibs.jcifs.smb.impl.SmbPipeHandleInternal#getSessionKey()
     */
    @Override
     ...
     * {@inheritDoc}
     *
     * @see org.codelibs.jcifs.smb.impl.SmbPipeHandleInternal#sendrecv(byte[], int, int, byte[], int)
     */
     ...
     * {@inheritDoc}
     *
     * @see org.codelibs.jcifs.smb.impl.SmbPipeHandleInternal#getPipeType()
     */
    @Override
