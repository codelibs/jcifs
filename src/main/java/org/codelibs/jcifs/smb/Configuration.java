...
public interface Configuration {
    ...
    /**
     * Property {@code jcifs.client.preferredCiphers} (string, default "AES_128_GCM,AES_128_CCM,AES_256_GCM,AES_256_CCM")
     *
    ...
    /**
     * Property {@code jcifs.client.aes256Enabled} (boolean, default true)
     *
    ...
    /**
     * Property {@code jcifs.client.useLease} (boolean, default true)
     *
    ...
    /**
     * Property {@code jcifs.client.leaseTimeout} (int, default 30000)
     *
    ...
    /**
     * Property {@code jcifs.client.maxLeases} (int, default 1000)
     *
    ...
    /**
     * Property {@code jcifs.client.leaseVersion} (int, default 2)
     *
    ...
    /**
     * Property {@code jcifs.client.leaseBreakTimeout} (int, default 60)
     *
    ...
    /**
     * Property {@code jcifs.client.useDurableHandles}, defaults to true
     *
    ...
    /**
     * Property {@code jcifs.client.usePersistentHandles}, defaults to false
     *
    ...
    /**
     * Property {@code jcifs.client.durableHandleTimeout}, defaults to 120000
     *
    ...
    /**
     * Property {@code jcifs.client.handleReconnectRetries}, defaults to 3
     *
     ...
     *
     * Property {@code jcifs.client.useMultiChannel} (boolean, default true)
     *
     ...
     *
     * Property {@code jcifs.client.maxChannels} (int, default 4)
     *
     ...
     *
     * Property {@code jcifs.client.channelBindingPolicy} (String, default "preferred")
     ...
     *
     * Property {@code jcifs.client.loadBalancingStrategy} (String, default "adaptive")
     ...
     *
     * Property {@code jcifs.client.channelHealthCheckInterval} (int, default 10)
     *
    ...
    /**
     * Property {@code jcifs.client.handleStateDirectory}
     *
    ...
    /**
     * Property {@code jcifs.client.useDirectoryLeasing} (boolean, default true)
     *
    ...
    /**
     * Property {@code jcifs.client.directoryCacheScope} (String, default "IMMEDIATE_CHILDREN")
     *
    ...
    /**
     * Property {@code jcifs.client.directoryCacheTimeout} (long, default 30000)
     *
    ...
    /**
     * Property {@code jcifs.client.directoryNotificationsEnabled} (boolean, default true)
     *
    ...
    /**
     * Property {@code jcifs.client.maxDirectoryCacheEntries} (int, default 1000)
     *
    ...
    /**
     * Checks whether to use SMB3 leases for client-side caching
     *
    ...
    /**
     * Gets the timeout for persistent handles
     *
