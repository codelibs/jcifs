 ...
 *
 * @see org.codelibs.jcifs.smb.impl.SmbFile for the main implementation of this interface
 * @author mbechler
 */
public interface SmbResource extends AutoCloseable {
     ...
     * @throws CIFSException if an error occurs modifying the resource
     * @throws org.codelibs.jcifs.smb.impl.SmbUnsupportedOperationException
