 ...
 *
 * @see org.codelibs.jcifs.smb.SmbFile for the main implementation of this interface
 * @author mbechler
 */
public interface SmbResource extends AutoCloseable {
     ...
     * @throws CIFSException if an error occurs modifying the resource
     * @throws org.codelibs.jcifs.smb.SmbUnsupportedOperationException
     ...
     *
     * @throws CIFSException if an error occurs creating the directories
     */
     ...
     * @throws CIFSException if an error occurs renaming the resource
    ...
    /**
     * Return the resolved owner group SIDObject for this file or directory
     *
     * @return the owner group SIDObject, <code>null</code> if not present
     * @throws IOException if an I/O error occurs
     */
    SID getOwnerGroup() throws IOException;

    /**
     * Return the owner group SIDObject for this file or directory
     *
     * @param resolve
    ...
    /**
     * Return the resolved owner user SIDObject for this file or directory
     *
     * @return the owner user SIDObject, <code>null</code> if not present
     * @throws IOException if an I/O error occurs
     */
    SID getOwnerUser() throws IOException;

    /**
     * Return the owner user SIDObject for this file or directory
     *
     * @param resolve
