...
import org.codelibs.jcifs.smb.audit.SecurityAuditLogger;
...
public class NtlmPasswordAuthenticator implements Principal, CredentialsInternal, Serializable, AutoCloseable {
     ...
     * {@inheritDoc}
     *
     * @see org.codelibs.jcifs.smb.CredentialsInternal#createContext(org.codelibs.jcifs.smb.CIFSContext, java.lang.String, java.lang.String, byte[],
     *      boolean)
     */
    @Override
    ...
    public byte[] getAnsiHash(CIFSContext tc, byte[] chlng) throws GeneralSecurityException {
        ...
        if (compatibility < 3) {
            log.warn("Using insecure NTLMv1 authentication (LM compatibility level {}). "
                    + "Please upgrade to NTLMv2 by setting jcifs.lmCompatibility to 3 or higher.", compatibility);
        }
