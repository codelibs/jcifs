...
public class ServerResponseValidator {
    ...
    /**
     * Creates a new ServerResponseValidator instance for validating SMB server responses
     */
    public ServerResponseValidator() {
        // Default constructor
    }
     ...
     * @return the current validation statistics
     */
    ...
    public static class ValidationStats {
        ...
        /**
         * Creates validation statistics
         * @param totalValidations total number of validations performed
         * @param failedValidations number of failed validations
         * @param bufferOverflowsPrevented number of buffer overflows prevented
         * @param integerOverflowsPrevented number of integer overflows prevented
         */
        ...
        /**
         * Gets the number of buffer overflows prevented
         * @return buffer overflow prevention count
         */
        ...
        /**
         * Gets the number of integer overflows prevented
         * @return integer overflow prevention count
         */
        ...
        /**
         * Gets the validation failure rate
         * @return failure rate as a fraction between 0 and 1
         */
