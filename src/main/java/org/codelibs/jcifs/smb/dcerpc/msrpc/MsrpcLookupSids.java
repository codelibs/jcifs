 ...
 */
public class MsrpcLookupSids extends org.codelibs.jcifs.smb.dcerpc.msrpc.lsarpc.LsarLookupSids {
     ...
     */
    public MsrpcLookupSids(final LsaPolicyHandle policyHandle, final org.codelibs.jcifs.smb.SID[] sids) {
        super(policyHandle, new LsarSidArrayX(sids), new org.codelibs.jcifs.smb.dcerpc.msrpc.lsarpc.LsarRefDomainList(),
                new org.codelibs.jcifs.smb.dcerpc.msrpc.lsarpc.LsarTransNameArray(), (short) 1, sids.length);
        this.ptype = 0;
