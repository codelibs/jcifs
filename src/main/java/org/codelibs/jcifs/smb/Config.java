 ...
 *
 * We strongly suggest that you create an explicit {@link org.codelibs.jcifs.smb.context.CIFSContextWrapper}
 * with your desired config. It's base implementation {@link org.codelibs.jcifs.smb.context.BaseContext}
 * should be sufficient for most needs.
 *
 * If you want to retain the classic singleton behavior you can use
 * {@link org.codelibs.jcifs.smb.context.SingletonContext#getInstance()}
...
public class Config {
     ...
     *     at org.codelibs.jcifs.smb.impl.SmbFile.&lt;init&gt;(SmbFile.java:355)
     *     ...
     * </pre>
     * </blockquote>
     */
    ...
    public static InetAddress getLocalHost(final Properties props) {
        final String addr = props.getProperty("jcifs.client.laddr");
