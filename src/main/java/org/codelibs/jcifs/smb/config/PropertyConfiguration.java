...
public final class PropertyConfiguration extends BaseConfiguration implements Configuration {
    ...
    private void initFromProperties(Properties props) {
        ...
        value = props.getProperty("jcifs.client.username");
        if (value != null) {
            this.defaultUserName = value;
        }

        value = props.getProperty("jcifs.client.password");
        if (value != null) {
            this.defaultPassword = value;
        }

        value = props.getProperty("jcifs.client.domain");
        if (value != null) {
        ...
        value = props.getProperty("jcifs.client.connTimeout");
        if (value != null) {
            try {
        ...
        value = props.getProperty("jcifs.client.soTimeout");
        if (value != null) {
            try {
        ...
        value = props.getProperty("jcifs.client.useUnicode");
        if (value != null) {
            this.useUnicode = Boolean.parseBoolean(value);
        }

        value = props.getProperty("jcifs.client.useBatching");
        if (value != null) {
            this.useBatching = Boolean.parseBoolean(value);
        }

        value = props.getProperty("jcifs.client.signingPreferred");
        if (value != null) {
            this.signingPreferred = Boolean.parseBoolean(value);
        }

        value = props.getProperty("jcifs.client.signingEnforced");
        if (value != null) {
            this.signingEnforced = Boolean.parseBoolean(value);
        }

        value = props.getProperty("jcifs.client.encryptionEnforced");
        if (value != null) {
            this.encryptionEnabled = Boolean.parseBoolean(value);
        }

        value = props.getProperty("jcifs.client.disablePlainTextPasswords");
        if (value != null) {
        ...
        value = props.getProperty("jcifs.client.nativeOs");
        if (value != null) {
            this.nativeOs = value;
        }

        value = props.getProperty("jcifs.client.nativeLanMan");
        if (value != null) {
            this.nativeLanMan = value;
        }

        // Dialect version properties - these should throw exceptions for invalid values
        String minVersion = props.getProperty("jcifs.client.minVersion");
        String maxVersion = props.getProperty("jcifs.client.maxVersion");
        if (minVersion != null || maxVersion != null) {
            initProtocolVersions(minVersion, maxVersion);
        }

        // Multi-Channel Configuration
        value = props.getProperty("jcifs.client.useMultiChannel");
        if (value != null) {
        ...
        value = props.getProperty("jcifs.client.maxChannels");
        if (value != null) {
            try {
        ...
        value = props.getProperty("jcifs.client.channelBindingPolicy");
        if (value != null) {
            this.channelBindingPolicy = initChannelBindingPolicy(value);
        }

        value = props.getProperty("jcifs.client.loadBalancingStrategy");
        if (value != null && !value.trim().isEmpty()) {
            this.loadBalancingStrategy = value.trim();
        }

        value = props.getProperty("jcifs.client.channelHealthCheckInterval");
        if (value != null) {
            try {
                int intValue = Integer.parseInt(value);
                if (intValue > 0) {
        ...
        value = props.getProperty("jcifs.client.useDirectoryLeasing");
        if (value != null) {
            this.useDirectoryLeasing = Boolean.parseBoolean(value);
        }

        value = props.getProperty("jcifs.client.directoryCacheScope");
        if (value != null) {
            this.directoryCacheScope = value;
        }

        value = props.getProperty("jcifs.client.directoryCacheTimeout");
        if (value != null) {
            try {
        ...
        value = props.getProperty("jcifs.client.directoryNotificationsEnabled");
        if (value != null) {
            this.directoryNotificationsEnabled = Boolean.parseBoolean(value);
        }

        value = props.getProperty("jcifs.client.maxDirectoryCacheEntries");
        if (value != null) {
            try {
        ...
        // RDMA Configuration
        value = props.getProperty("jcifs.client.useRDMA");
        if (value != null) {
            this.useRDMA = Boolean.parseBoolean(value);
        }

        value = props.getProperty("jcifs.client.rdmaProvider");
        if (value != null) {
            this.rdmaProvider = value;
        }

        value = props.getProperty("jcifs.client.rdmaReadWriteThreshold");
        if (value != null) {
            try {
        ...
        value = props.getProperty("jcifs.client.rdmaMaxSendSize");
        if (value != null) {
            try {
        ...
        value = props.getProperty("jcifs.client.rdmaMaxReceiveSize");
        if (value != null) {
            try {
        ...
        value = props.getProperty("jcifs.client.rdmaCredits");
        if (value != null) {
            try {
        ...
        // RDMA port
        value = props.getProperty("jcifs.client.rdmaPort");
        if (value != null) {
            try {
        ...
        value = props.getProperty("jcifs.client.useWitness");
        if (value != null) {
            this.useWitness = Boolean.parseBoolean(value);
        }

        value = props.getProperty("jcifs.client.witnessHeartbeatTimeout");
        if (value != null) {
            try {
        ...
        value = props.getProperty("jcifs.client.witnessRegistrationTimeout");
        if (value != null) {
            try {
        ...
        value = props.getProperty("jcifs.client.witnessReconnectDelay");
        if (value != null) {
            try {
        ...
        value = props.getProperty("jcifs.client.witnessServiceDiscovery");
        if (value != null) {
            this.witnessServiceDiscovery = Boolean.parseBoolean(value);
        }

        value = props.getProperty("jcifs.client.useLeases");
        if (value != null) {
            this.useLeases = Boolean.parseBoolean(value);
        }

        value = props.getProperty("jcifs.client.usePersistentHandles");
        if (value != null) {
            this.usePersistentHandles = Boolean.parseBoolean(value);
        }

        value = props.getProperty("jcifs.client.persistentHandleTimeout");
        if (value != null) {
            try {
