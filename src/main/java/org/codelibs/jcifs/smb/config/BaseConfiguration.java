...
public class BaseConfiguration implements Configuration {
    ...
    /**
     * Whether to use SMB3 leases for client-side caching
     */
    protected boolean useLeases = true;

    /**
     * Timeout for persistent handles in milliseconds
     */
    ...
    protected void initResolverOrder(final String ro) {
        ...
        if (ro == null || ro.length() == 0) {
             ...
             * LMHOSTS,DNS,BCAST if org.codelibs.jcifs.smb.netbios.wins has not
             * been specified.
             */
