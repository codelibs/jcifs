...
public class SmbComTreeConnectAndX extends AndXServerMessageBlock {
    ...
    private static boolean isExternalAuth(final NtlmPasswordAuthenticator pwAuth) {
        return pwAuth instanceof org.codelibs.jcifs.smb.impl.NtlmPasswordAuthentication
                && !((org.codelibs.jcifs.smb.impl.NtlmPasswordAuthentication) pwAuth).areHashesExternal() && pwAuth.getPassword().isEmpty();
    }
