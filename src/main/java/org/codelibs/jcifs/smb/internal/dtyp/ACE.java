 ...
 * available online).
 * <p>
 * Direct ACEs are evaluated first in order. The SIDObject of the user performing
 * the operation and the desired access bits are compared to the SIDObject
 * and access mask of each ACE. If the SIDObject matches, the allow/deny flags
 ...
 *
 */
public class ACE implements org.codelibs.jcifs.smb.ACE, Decodable {
