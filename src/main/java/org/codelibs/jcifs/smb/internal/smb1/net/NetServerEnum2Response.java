...
public class NetServerEnum2Response extends SmbComTransactionResponse {
    ...
    class ServerInfo1 implements FileEntry {
         ...
         * {@inheritDoc}
         *
         * @see org.codelibs.jcifs.smb.FileEntry#getFileIndex()
         */
        @Override
        ...
        public String toString() {
            return ("ServerInfo1[" + "name=" + this.name + ",versionMajor=" + this.versionMajor + ",versionMinor=" + this.versionMinor
                    + ",type=0x" + Hexdump.toHexString(this.type, 8) + ",commentOrMasterBrowser=" + this.commentOrMasterBrowser + "]");
        }
    }
    ...
    @Override
    public String toString() {
        return ("NetServerEnum2Response[" + super.toString() + ",status=" + this.getStatus() + ",converter=" + this.converter
                + ",entriesReturned=" + this.getNumEntries() + ",totalAvailableEntries=" + this.totalAvailableEntries + ",lastName="
                + this.lastName + "]");
    }
}
