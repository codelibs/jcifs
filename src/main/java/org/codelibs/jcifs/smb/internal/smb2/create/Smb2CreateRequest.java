...
public class Smb2CreateRequest extends ServerMessageBlock2Request<Smb2CreateResponse> implements RequestWithPath {
     ...
     * {@inheritDoc}
     *
     * @see org.codelibs.jcifs.smb.internal.RequestWithPath#getPath()
     */
    @Override
     ...
     * Strips a leading \
     *
     * @see org.codelibs.jcifs.smb.internal.RequestWithPath#setPath(java.lang.String)
     */
    @Override
    ...
    public void addDurableHandleV1Context() {
        addCreateContext(new org.codelibs.jcifs.smb.internal.smb2.persistent.DurableHandleRequest());
    }
     ...
     */
    public org.codelibs.jcifs.smb.internal.smb2.persistent.HandleGuid addDurableHandleV2Context(long timeoutMs, boolean persistent) {
        org.codelibs.jcifs.smb.internal.smb2.persistent.DurableHandleV2Request context =
                new org.codelibs.jcifs.smb.internal.smb2.persistent.DurableHandleV2Request(timeoutMs, persistent);
     ...
     */
    public void addDurableHandleV2Context(long timeoutMs, boolean persistent,
            org.codelibs.jcifs.smb.internal.smb2.persistent.HandleGuid createGuid) {
        org.codelibs.jcifs.smb.internal.smb2.persistent.DurableHandleV2Request context =
                new org.codelibs.jcifs.smb.internal.smb2.persistent.DurableHandleV2Request(timeoutMs, persistent, createGuid);
        addCreateContext(context);
    }
    ...
    public void addDurableHandleReconnectContext(byte[] fileId) {
        addCreateContext(new org.codelibs.jcifs.smb.internal.smb2.persistent.DurableHandleReconnect(fileId));
    }
    ...
    public boolean hasDurableHandleContext() {
        if (this.createContexts != null) {
            for (CreateContextRequest ctx : this.createContexts) {
                if (ctx instanceof org.codelibs.jcifs.smb.internal.smb2.persistent.DurableHandleRequest
                        || ctx instanceof org.codelibs.jcifs.smb.internal.smb2.persistent.DurableHandleV2Request
                        || ctx instanceof org.codelibs.jcifs.smb.internal.smb2.persistent.DurableHandleReconnect) {
                    return true;
                }
            }
        }
