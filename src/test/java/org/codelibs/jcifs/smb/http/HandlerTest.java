...
class HandlerTest {
    ...
    void testOpenConnection_WithSystemPropertyHandler_SkipsJcifsPackage() throws Exception {
        // This test verifies that the handler resolution mechanism correctly skips the 'org.codelibs.jcifs.smb'
        ...
        assertNotNull(connection, "Connection should not be null even when org.codelibs.jcifs.smb is in handler path.");
