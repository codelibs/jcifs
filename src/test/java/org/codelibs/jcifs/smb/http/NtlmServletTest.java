...
class NtlmServletTest {
    ...
    @Mock
    private org.codelibs.jcifs.smb.SmbTransportPool transportPool;
    ...
    void testInitWithCIFSException() {
        ...
        validParams.put("jcifs.client.domain", "TEST_DOMAIN");
        validParams.put("jcifs.client.soTimeout", "300000");
