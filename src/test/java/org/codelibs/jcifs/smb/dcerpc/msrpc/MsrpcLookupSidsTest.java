...
class MsrpcLookupSidsTest {
    ...
    private org.codelibs.jcifs.smb.SID[] testSids;
    ...
    void constructor_shouldInitializeWithValidParameters() {
        // Arrange
        org.codelibs.jcifs.smb.SID mockSid1 = mock(org.codelibs.jcifs.smb.SID.class);
        org.codelibs.jcifs.smb.SID mockSid2 = mock(org.codelibs.jcifs.smb.SID.class);
        when(mockSid1.unwrap(sid_t.class)).thenReturn(mockSidT);
        when(mockSid2.unwrap(sid_t.class)).thenReturn(mockSidT);
        testSids = new org.codelibs.jcifs.smb.SID[] { mockSid1, mockSid2 };
    ...
    void constructor_shouldHandleSingleSid() {
        // Arrange
        org.codelibs.jcifs.smb.SID mockSid = mock(org.codelibs.jcifs.smb.SID.class);
        when(mockSid.unwrap(sid_t.class)).thenReturn(mockSidT);
        testSids = new org.codelibs.jcifs.smb.SID[] { mockSid };
    ...
    void constructor_shouldHandleMultipleSids() {
        ...
        org.codelibs.jcifs.smb.SID mockSid1 = mock(org.codelibs.jcifs.smb.SID.class);
        org.codelibs.jcifs.smb.SID mockSid2 = mock(org.codelibs.jcifs.smb.SID.class);
        org.codelibs.jcifs.smb.SID mockSid3 = mock(org.codelibs.jcifs.smb.SID.class);
        when(mockSid1.unwrap(sid_t.class)).thenReturn(mockSidT);
        when(mockSid2.unwrap(sid_t.class)).thenReturn(mockSidT);
        when(mockSid3.unwrap(sid_t.class)).thenReturn(mockSidT);
        testSids = new org.codelibs.jcifs.smb.SID[] { mockSid1, mockSid2, mockSid3 };
    ...
    void constructor_shouldHandleEmptySidArray() {
        // Arrange
        testSids = new org.codelibs.jcifs.smb.SID[0];
    ...
    void constructor_shouldThrowExceptionWithNullSids() {
        // Act & Assert - Null SIDObject array causes NPE when accessing length
    ...
    void constructor_shouldHandleVariousSidArraySizes(int size) {
        // Arrange
        testSids = new org.codelibs.jcifs.smb.SID[size];
        for (int i = 0; i < size; i++) {
            testSids[i] = mock(org.codelibs.jcifs.smb.SID.class);
    ...
    void constructor_shouldHandleSidsWithNullElements() {
        ...
        testSids = new org.codelibs.jcifs.smb.SID[] { mockSid1, null, mockSid2 };
    ...
    void constructor_shouldHandleLargeSidArray() {
        // Arrange
        int largeSize = 1000;
        testSids = new org.codelibs.jcifs.smb.SID[largeSize];
    ...
    void constructor_shouldPassCorrectCountToSuperclass() throws Exception {
        // Arrange
        int expectedCount = 7;
        testSids = new org.codelibs.jcifs.smb.SID[expectedCount];
