...
class MsrpcSamrOpenAliasTest {
    ...
    void testConstructorInitialization() {
        ...
        try {
            java.lang.reflect.Field ptypeField = org.codelibs.jcifs.smb.dcerpc.DcerpcMessage.class.getDeclaredField("ptype");
            ptypeField.setAccessible(true);
            assertEquals(0, ptypeField.get(msrpcSamrOpenAlias), "ptype should be initialized to 0");

            java.lang.reflect.Field flagsField = org.codelibs.jcifs.smb.dcerpc.DcerpcMessage.class.getDeclaredField("flags");
