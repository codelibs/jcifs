...
class SamrPolicyHandleTest {
    ...
    void testClose_SmbExceptionOnClose() throws IOException {
        // Test case: close() with non-zero retval from MsrpcSamrCloseHandle, should throw SmbSystemException
        String server = "testServer";
        int access = 123;
        ...
        // SmbSystemException constructor maps non-NT status codes to NT_STATUS_UNSUCCESSFUL
