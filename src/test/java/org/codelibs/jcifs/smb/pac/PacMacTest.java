...
class PacMacTest {
    ...
    /**
     * Test method for
     * {@link org.codelibs.jcifs.smb.pac.PacMac#calculateMacArcfourHMACMD5(int, java.security.Key, byte[])}.
     *
    ...
    /**
     * Test method for
     * {@link org.codelibs.jcifs.smb.pac.PacMac#calculateMacHMACAES(int, javax.security.auth.kerberos.KerberosKey, byte[])}.
     *
     * @throws GeneralSecurityException
     */
    @Test
    ...
    /**
     * Test method for
     * {@link org.codelibs.jcifs.smb.pac.PacMac#deriveKeyAES(javax.security.auth.kerberos.KerberosKey, byte[])}.
     *
     * @throws GeneralSecurityException
     */
    @Test
    ...
    /**
     * Test method for {@link org.codelibs.jcifs.smb.pac.PacMac#expandNFold(byte[], int)}.
     */
    @Test
    ...
    /**
     * Test method for
     * {@link org.codelibs.jcifs.smb.pac.PacMac#calculateMac(int, java.util.Map, byte[])}.
     *
