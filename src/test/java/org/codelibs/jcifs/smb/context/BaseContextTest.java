...
class BaseContextTest extends BaseTest {
    ...
    void testConstructorInitialization() {
        ...
        assertNotNull(context.getSIDResolver(), "SIDObject resolver should be initialized");
    ...
    @Test
    @DisplayName("getSIDResolver should return initialized SIDObject resolver")
    void testGetSIDResolver() {
        // When
        SidResolver sidResolver = context.getSIDResolver();

        // Then
        assertNotNull(sidResolver, "SIDObject resolver should not be null");
    ...
    void testInterfaceImplementation() {
        // Then
        assertTrue(context instanceof org.codelibs.jcifs.smb.CIFSContext, "BaseContext should implement CIFSContext interface");
    }
    ...
    void testWithRealConfiguration() throws CIFSException {
        ...
        assertNotNull(realContext.getSIDResolver(), "SIDObject resolver should be initialized");
