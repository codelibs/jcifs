...
final class TransWaitNamedPipeResponseTest {
    ...
    class WireFormatMethods {
        ...
        void writeSetupWireFormatReturnsZero(int index) {
            TransWaitNamedPipeResponse resp = new TransWaitNamedPipeResponse();
            assertEquals(0, resp.writeSetupWireFormat(new byte[10], index), "writeSetupWireFormat should always return 0");
        }
        ...
        void writeParametersWireFormatReturnsZero(int index) {
            TransWaitNamedPipeResponse resp = new TransWaitNamedPipeResponse();
            assertEquals(0, resp.writeParametersWireFormat(new byte[10], index), "writeParametersWireFormat should always return 0");
        }
        ...
        void readSetupWireFormatReturnsZero(int len) {
            TransWaitNamedPipeResponse resp = new TransWaitNamedPipeResponse();
            assertEquals(0, resp.readSetupWireFormat(new byte[10], 0, len), "readSetupWireFormat should always return 0");
        }
