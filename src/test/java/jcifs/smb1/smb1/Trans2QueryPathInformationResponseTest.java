...
class Trans2QueryPathInformationResponseTest {
    ...
    class SmbQueryFileBasicInfoTests {
        ...
        void testBasicInfoCreation() {
            Trans2QueryPathInformationResponse.SmbQueryFileBasicInfo basicInfo = 
                response.new SmbQueryFileBasicInfo();
    ...
    class SmbQueryFileStandardInfoTests {
        ...
        void testStandardInfoCreation() {
            Trans2QueryPathInformationResponse.SmbQueryFileStandardInfo standardInfo = 
                response.new SmbQueryFileStandardInfo();
