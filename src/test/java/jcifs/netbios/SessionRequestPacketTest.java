...
class SessionRequestPacketTest {
    ...
    void testReadTrailerWireFormatSuccess() throws IOException {
        SessionRequestPacket writePacket = new SessionRequestPacket(mockConfig, 
            new TestNetbiosName("SERVER", 0x20, null),
            new TestNetbiosName("CLIENT", 0x00, null));
    ...
    void testWriteTrailerWireFormatVariousNames(String calledName, int calledType, 
                                                 String callingName, int callingType) {
        SessionRequestPacket packet = new SessionRequestPacket(mockConfig,
            new TestNetbiosName(calledName, calledType, null),
    ...
    private static Stream<Arguments> provideNamesForWriteTest() {
        return Stream.of(
            Arguments.of("SERVER", 0x20, "CLIENT", 0x00),
            Arguments.of("WORKSTATION", 0x00, "USER", 0x03),
            Arguments.of("DOMAIN", 0x1B, "BROWSER", 0x1D),
            Arguments.of("A", 0x20, "B", 0x00),
    ...
    void testFullWriteReadCycle() throws IOException {
        ...
        SessionRequestPacket originalPacket = new SessionRequestPacket(mockConfig,
            new TestNetbiosName("FILESERVER", 0x20, "CORP.LOCAL"),
