...
class ServerMessageBlockTest {
    ...
    class ConstructorTests {
        ...
        void testConstructorWithConfig() {
            ...
            assertEquals(SmbConstants.FLAGS_PATH_NAMES_CASELESS | SmbConstants.FLAGS_PATH_NAMES_CANONICALIZED, 
                        testBlock.getFlags());
        }
    ...
    class UtilityMethodTests {
        ...
        void testToStringAllCommands() {
            byte[] commands = {
                ServerMessageBlock.SMB_COM_CREATE_DIRECTORY,
                ServerMessageBlock.SMB_COM_DELETE_DIRECTORY,
                ServerMessageBlock.SMB_COM_CLOSE,
                ServerMessageBlock.SMB_COM_DELETE,
                ServerMessageBlock.SMB_COM_RENAME,
                ServerMessageBlock.SMB_COM_QUERY_INFORMATION,
                ServerMessageBlock.SMB_COM_CHECK_DIRECTORY,
                ServerMessageBlock.SMB_COM_TRANSACTION,
                ServerMessageBlock.SMB_COM_TRANSACTION2,
                ServerMessageBlock.SMB_COM_TRANSACTION_SECONDARY,
                ServerMessageBlock.SMB_COM_FIND_CLOSE2,
                ServerMessageBlock.SMB_COM_TREE_DISCONNECT,
                ServerMessageBlock.SMB_COM_SESSION_SETUP_ANDX,
                ServerMessageBlock.SMB_COM_LOGOFF_ANDX,
                ServerMessageBlock.SMB_COM_ECHO,
                ServerMessageBlock.SMB_COM_MOVE,
                ServerMessageBlock.SMB_COM_OPEN_ANDX,
                ServerMessageBlock.SMB_COM_READ_ANDX,
                ServerMessageBlock.SMB_COM_WRITE_ANDX,
                ServerMessageBlock.SMB_COM_NT_CREATE_ANDX,
                ServerMessageBlock.SMB_COM_NT_TRANSACT,
                ServerMessageBlock.SMB_COM_NT_TRANSACT_SECONDARY,
                ServerMessageBlock.SMB_COM_LOCKING_ANDX,
                (byte) 0xFF
            };
            ...
            for (int i = 0; i < commands.length; i++) {
                ...
                String result = testBlock.toString();
                assertTrue(result.contains("command=" + expectedStrings[i]),
                          "Expected: " + expectedStrings[i] + " in result: " + result);
            }
        }
    }
