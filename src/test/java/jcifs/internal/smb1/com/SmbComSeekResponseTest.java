...
class SmbComSeekResponseTest {
    ...
    static java.util.stream.Stream<Arguments> int32Provider() {
        return java.util.stream.Stream.of(
            Arguments.of(0x00000000, new byte[] { 0x00, 0x00, 0x00, 0x00 }),
    ...
    void testReadParameterWordsWithNullBuffer() {
        assertThrows(NullPointerException.class, () ->
            response.readParameterWordsWireFormat(null, 0)
        );
    }
    ...
    void testReadParameterWordsWithOffsetBeyondBuffer() {
        ...
        assertThrows(ArrayIndexOutOfBoundsException.class, () ->
            response.readParameterWordsWireFormat(buffer, 2) // Only 3 bytes available from offset 2
        );
    }
