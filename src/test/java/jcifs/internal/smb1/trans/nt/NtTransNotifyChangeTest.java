...
class NtTransNotifyChangeTest {
    ...
    private static Stream<Arguments> completionFilterProvider() {
        return Stream.of(
            Arguments.of(FILE_NOTIFY_CHANGE_FILE_NAME, "File name changes"),
            Arguments.of(FILE_NOTIFY_CHANGE_DIR_NAME, "Directory name changes"),
            Arguments.of(FILE_NOTIFY_CHANGE_ATTRIBUTES, "Attribute changes"),
            Arguments.of(FILE_NOTIFY_CHANGE_SIZE, "Size changes"),
            ...
            Arguments.of(FILE_NOTIFY_CHANGE_ALL, "All changes"),
            Arguments.of(0x00000000, "No filters"),
    ...
    void testCombinedCompletionFilters() {
        int combinedFilter = FILE_NOTIFY_CHANGE_FILE_NAME | 
