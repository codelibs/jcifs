...
class SmbNegotiationTest {
    ...
    void testWithEmptyBuffers() {
        ...
        SmbNegotiation negotiationWithEmptyBuffers = new SmbNegotiation(
            mockRequest, mockResponse, emptyRequestBuffer, emptyResponseBuffer
        );
    ...
    void testWithLargeBuffers() {
        ...
        SmbNegotiation negotiationWithLargeBuffers = new SmbNegotiation(
            mockRequest, mockResponse, largeRequestBuffer, largeResponseBuffer
        );
    ...
    void testWithDifferentBufferSizes() {
        ...
        SmbNegotiation negotiationDifferentSizes = new SmbNegotiation(
            mockRequest, mockResponse, smallBuffer, mediumBuffer
        );
    ...
    void testMultipleInstances() {
        ...
        SmbNegotiation anotherNegotiation = new SmbNegotiation(
            anotherRequest, anotherResponse, anotherRequestBuffer, anotherResponseBuffer
        );
