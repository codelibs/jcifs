/*
 * © 2025 Test Class for Smb2WriteRequest
 * 
...
class Smb2WriteRequestTest {
    ...
    class WriteBytesWireFormatTests {
        ...
        void testPartialDataBuffer() {
            ...
            assertArrayEquals(
                Arrays.copyOfRange(fullData, offset, offset + length),
                Arrays.copyOfRange(buffer, 48, 48 + length)
            );
        }
    ...
    class EdgeCaseTests {
        ...
        void testLongFileId() {
            ...
            assertArrayEquals(
                Arrays.copyOfRange(longFileId, 0, 16),
