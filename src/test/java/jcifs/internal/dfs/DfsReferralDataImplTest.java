...
class DfsReferralDataImplTest {
    ...
    class UnwrapTests {
        ...
        void testUnwrapToIncompatibleType() {
            ...
            class IncompatibleReferralData implements DfsReferralData {
                ...
                @Override
                public int getPathConsumed() { return 0; }
                @Override
                ...
                @Override
                public String getShare() { return null; }
                @Override
                public String getPath() { return null; }
                @Override
                public DfsReferralData next() { return null; }
            }
    ...
    class FromReferralTests {
        ...
        @ValueSource(strings = {
            ...
            "\\server\\share",
            "\\server\\share\\path",
            "\\server\\share\\path\\subpath\\file.txt"
        })
    ...
    class CombineTests {
        ...
        void testCombine() {
            ...
            first = DfsReferralDataImpl.fromReferral(
                mockReferral, "\\\\server1\\share1\\path1", 
            ...
            second = DfsReferralDataImpl.fromReferral(
                mockReferral, "\\\\server2\\share2\\path2",
                System.currentTimeMillis() + 20000, 15
            );
        ...
        void testCombineWithNullPath() {
            ...
            first = DfsReferralDataImpl.fromReferral(
                mockReferral, "\\\\domain\\root", 
                System.currentTimeMillis() + 10000, 10
            );
    ...
    class ToStringTests {
        ...
        void testToString() {
            ...
            referralData = DfsReferralDataImpl.fromReferral(
                mockReferral, "\\\\server\\share\\folder", expiration, 20
            );
    ...
    class EqualsHashCodeTests {
        ...
        void testNotEqualDifferentServer() {
            ...
            DfsReferralDataImpl other = DfsReferralDataImpl.fromReferral(
                mockReferral, "\\\\otherserver\\share\\path",
                System.currentTimeMillis() + 10000, 20
            );
        ...
        void testNotEqualDifferentShare() {
            ...
            DfsReferralDataImpl other = DfsReferralDataImpl.fromReferral(
                mockReferral, "\\\\server\\othershare\\path",
                System.currentTimeMillis() + 10000, 20
            );
        ...
        void testNotEqualDifferentPath() {
            ...
            DfsReferralDataImpl other = DfsReferralDataImpl.fromReferral(
                mockReferral, "\\\\server\\share\\otherpath",
                System.currentTimeMillis() + 10000, 20
            );
    ...
    class EdgeCasesTests {
        ...
        void testVeryLongPaths() {
            ...
            DfsReferralDataImpl result = DfsReferralDataImpl.fromReferral(
                mockReferral, longPath.toString(),
                System.currentTimeMillis() + 10000, 50
            );
